...
export class AdivinarPersonaje extends Component {
    ...
    render(){
      ...
      if(this.state.done !== true){
        return (
          ...
          <Image resizeMode="contain" style={styles.formatoImagen} source={require('../img/logo.gif')}/>
        ...
        return (
          <View style={styles.container}>
          <Image resizeMode="contain" style={styles.formatoImagen} source={require('../img/logo2.gif')}/>
